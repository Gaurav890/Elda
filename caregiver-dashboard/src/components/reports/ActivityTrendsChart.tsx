...
import type { ActivityData } from '@/types/report';
...
export function ActivityTrendsChart({
  ...
  const trendConfig = {
    up: { icon: TrendingUp, color: 'text-green-600', bg: 'bg-green-100', text: 'Increasing' },
    down: { icon: TrendingDown, color: 'text-orange-600', bg: 'bg-orange-100', text: 'Decreasing' },
    ...
    <Card className="p-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Daily activity duration in minutes</p>
        </div>
        <div className="text-right">
          <div className="text-2xl font-bold text-gray-900">{average} min</div>
      ...
      <div className="mt-4 pt-4 border-t border-gray-200">
        <div className="flex items-center justify-between text-sm">
          ...
          <span className="text-gray-500">Goal: 30+ min/day</span>
        </div>
      </div>
    </Card>
  );
