...
class TTSService {
  ...
  private defaultOptions: TTSOptions = {
    speed: 0.45, // Optimized speed for elderly users (0.45 = 45% of normal speed - slower and clearer)
    pitch: 1.0,
    language: 'en-US',
  };
  ...
  private async initializeTTS(): Promise<void> {
    try {
      // Set default speech rate (0.45 = 45% speed for elderly users - slower and clearer)
      await Tts.setDefaultRate(this.defaultOptions.speed || 0.45);
